...
def generate_run_file(
    ...
    if htc:
        ...
        file_str = _generate_run_file(job_folder, job_name, setup_env_script, additionnal_command)
...
def _generate_run_file(job_folder, job_name, setup_env_script, additionnal_command=""):
    return (
        "#!/bin/bash\n"
